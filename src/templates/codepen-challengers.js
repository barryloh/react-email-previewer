export function getCodepenChallengersTemplate() {
  return {
    payload: {
      baseUrl: 'https://demo.react.email',
    },
    styles: `const main = {
  ...
  cursor: "pointer",
    ...
    <Body style={main}>
      <Section style={header}>
        <Img
          style={imgHeader}
          src={\`https://demo.react.email/static/codepen-challengers.png\`}
          width={600}
          alt="codepen"
        />
      </Section>
      <Container style={container}>
        ...
        <Section style={section}>
          ...
          <Img
            style={imgCube}
            src={\`https://demo.react.email/static/codepen-cube.png\`}
            width={600}
            alt="codepen"
          />
          ...
          <Section style={sectionPro}>
            <Img
              style={imagePro}
              src={\`https://demo.react.email/static/codepen-pro.png\`}
              width={250}
              alt="codepen"
            />
